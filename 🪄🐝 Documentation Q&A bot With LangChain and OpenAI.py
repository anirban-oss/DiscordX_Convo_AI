...
def load_vectostore():
  artifact = run.use_artifact('parambharat/wandb_docs_bot/faiss_store:latest',
                              type='search_index')
...
if __name__ == "__main__":
  demo.queue().launch(share=False, server_name='0.0.0.0', server_port=85, show_error=True)
